...
Pseudo-code: This is code structure written in plain english 

1. Input the gross income and number of dependents
2. Compute the taxable income using formula: 
...
print("Your Income Tax, based on your taxable income of", taxableIncome "is", incomeTax, ".")   qwa